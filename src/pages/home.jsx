...
const Home = () => {
  return (
      ...
      <section className="header">
        <div className="container">
          <div className="d-flex flex-wrap">
            <div className="discover col-md-6">
          ...
          <div className="col-lg-6 col-md-6 col-sm-12 mb-1 d-flex align-items-center">
            <div className="pe-3">
              <h1 className="fw-bolder text-dark pt-3">
                <img
                  src="../assets/imgs/Health, Sport, Apple watch.png"
                  alt=""
                  width="50"
                  className="mb-4"
                />
    ...
    <Accordion className="accordion" style={{background: 'url("your-background-image-url.jpg")'}}>
